...
class Ajaba(_Fera):
    ...
    field_defaults = {"Breed": "Homid", "Aspect": "Dawn"}
...
class Bastet(_Fera):
    ...
    field_defaults = {"Pyrio": "Daylight", "Breed": "Homid", "Tribe": "Bagheera"}
...
class Camazotz(_Fera):
    fields = ["Breed"]
    field_choices = {"Breed": ["Homid", "Chiroptera"]}
...
class Corax(_Fera):
    ...
    field_Defaults = {"Breed": "Homid", "Tribe": "Chasers"}
...
class Garou(_Fera):
    ...
    field_defaults = {"Breed": "Homid", "Auspice": "Ragabash"}
...
class Grondr(_Fera):
    fields = ["Breed"]
    field_choices = {"Breed": ["Homid", "Metis", "Scrofa"]}
...
class Gurahl(_Fera):
    ...
    field_defaults = {"Auspice": "Arcas", "Breed": "Homid", "Tribe": "Forest Walkers"}
...
class Kitsune(_Fera):
    ...
    field_defaults = {"Breed": "Kojin", "Path": "Kataribe"}
...
class Nagah(_Fera):
    ...
    field_defaults = {"Breed": "Balaram", "Auspice": "Kamakshi"}
